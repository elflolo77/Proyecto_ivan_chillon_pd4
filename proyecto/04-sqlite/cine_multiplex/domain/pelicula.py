...
class Pelicula:
    ...
    @property
    def tipo(self):
        """Devuelve el identificador de tipo de la subclase (TIPO)."""
        return self.TIPO

    def campos_extra(self):
        """Devuelve un diccionario con los campos extra propios de la subclase."""
        return {}
...
class PeliculaComercial(Pelicula):
    ...
    def campos_extra(self):
        """Devuelve los campos extra de la película comercial."""
...
class PeliculaInfantil(Pelicula):
    ...
    def campos_extra(self):
        """Devuelve los campos extra de la película infantil."""
...
class PeliculaClasica(Pelicula):
    ...
    def campos_extra(self):
        """Devuelve los campos extra de la película clásica."""
